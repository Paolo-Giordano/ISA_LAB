...
#  Created on Fri Nov  5 12:55:43 2021                
#                                                     
#######################################################
...
set init_top_cell filter_opt
set init_verilog ../../netlist/filter_opt.v
...
timeDesign -postRoute -pathReports -drvReports -slackReports -numPaths 50 -prefix filter_opt_postRoute -outDir timingReports
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -preCTS -hold -pathReports -slackReports -numPaths 50 -prefix filter_opt_preCTS -outDir timingReports
...
reportGateCount -level 5 -limit 100 -outfile filter_opt.gateCount
all_hold_analysis_views 
all_setup_analysis_views 
write_sdf  -ideal_clock_network filter_opt.sdf
saveNetlist filter_opt.v
