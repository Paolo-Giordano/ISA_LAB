...
#  Created on Sun Oct 24 13:17:27 2021                
#                                                     
#######################################################
...
selectInst i_mult_0_mult_30_U18
...
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -preCTS -hold -pathReports -slackReports -numPaths 50 -prefix filter_preCTS -outDir timingReports
...
encMessage debug 0
encMessage info 0
restoreDesign /home/isa03_2021_2022/Lab_ISA/Lab_1/Paolo/lab1_vhdl/innovus/filter.enc.dat filter
setDrawView fplan
...
report_power -outfile post_p&r_power.txt -sort { total }
